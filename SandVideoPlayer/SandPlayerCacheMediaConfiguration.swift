//
//  SandPlayerCacheMediaConfiguration.swift
//  SandVideoPlayer
//
...
import Foundation
open class SandPlayerCacheMediaConfiguration: NSObject, NSCoding, NSCopying{
    ...
    public required convenience init?(coder aDecoder: NSCoder) {
        guard let fileName = aDecoder.decodeObject(forKey: "fileName") as? String,
            ...
            let cacheMedia = aDecoder.decodeObject(forKey:"cacheMedia") as? SandPlayerCacheMedia,
    ...
    public func copy(with zone: NSZone? = nil) -> Any {
        let confi = SandPlayerCacheMediaConfiguration()
...
// MARK: - Update
extension SandPlayerCacheMediaConfiguration {
    open func save() {
